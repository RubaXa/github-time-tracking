...
(function (window) {
	...
	var LOCAL_KEY = 'github-time-tacking';
	var TRACKER_ICON = (function () {
		var img = new Image;
		img.src = 'data:image/png;base64,';
	...
	function init() {
		...
		updUI();
		window.addEventListener('pop', updUI, false);
	}
	...
	/**
	 * Create & save model
	 * @param   {Parse.Object} Model
	 * @param   {Object}  attrs
	 * @returns {Promise}
	 */
	function newModel(Model, attrs) {
		return new Promise(function (resolve, reject) {
	...
	function findProject() {
		...
		return findProject[project] || (findProject[project] = initialize().then(function () {
			...
			return (new Promise(function (resolve) {
				(new Parse.Query(Project)).equalTo('name', project).find().then(function (results) {
					if (results.length) {
						resolve(results[0]);
					} else {
						newModel(Project, { name: project }).then(resolve);
					}
				});
			}));
		}));
	...
	/**
	 * Find issue by number in current project
	 * @param   {Number} num
	 * @returns {Promise}
	 */
	function findIssue(num) {
		return findIssue[num] || (findIssue[num] = findProject().then(function (project) {
			return new Promise(function (resolve) {
				(new Parse.Query(Issue))
					.equalTo('number', num)
					.equalTo('project', project.id)
					.find()
	...
	/**
	 * Find isuses in current project
	 * @returns {Promise}
	 */
	function findIssues() {
		return findProject().then(function (project) {
			var id = project.id;

			return findIssues[id] || (findIssues[id] = new Promise(function (resolve) {
				var list = (new Parse.Query(Issue)).equalTo('project', id).collection();
